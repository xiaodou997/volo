    ...
    <section class="automation-overview">
      ...
      <div class="policy-card">
        ...
        <ul>
          ...
          <li>Plugin Tool 可通过 Headless Runtime 后台执行；clipboard.read、非交互整屏 screen.capture、精确文件 fs.read 已支持，并要求对应 Workflow 的 Always 授权；交互式区域截图、写文件和其他未接入的高风险宿主 API 仍会明确拒绝。</li>
